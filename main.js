...
const checkPhone = ()=>{
    ...
    if (isEmpty(phoneValue)) {
        ...
        showError(phoneInput, "El telefono ingresado no es valido")
    } else {
...
form.addEventListener("submit", (e)=>{
    ...
    let isEmailValidd = checkMail();
    let isPasswordValid = checkPassword();
    let isPhoneValidd = checkPhone();

    let isFormValid = isUsernameValid && isEmailValidd && isPasswordValid && isPhoneValidd;
    if (isFormValid){
        form.submit();
    }
})
